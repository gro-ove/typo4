...
namespace TypoLib.Utils.Windows {
    public static class User32 {
        ...
        public static extern uint SendInput(uint numberOfInputs, Input[] input, int sizeOfInputStructure);
        ...
        public static uint SendInput(IEnumerable<KeyboardInput> input) {
            var array = input.Select(x => new Input(x)).ToArray();
