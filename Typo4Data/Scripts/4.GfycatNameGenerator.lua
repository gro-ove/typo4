...
function adjective()
    return adjectives[math.random(1501)]
end

function animal()
    return animals[math.random(1750)]
end
...
if math.random(2) == 1 then
    return prepare(adjective()) .. " " .. prepare(animal())
else
    return prepare(adjective()) .. " " .. prepare(adjective()) .. " " .. prepare(animal())
end